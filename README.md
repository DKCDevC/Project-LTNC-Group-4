...
### ⚠️ Lỗi 1: `java.net.BindException: Address already in use: JVM_Bind`
...
### ⚠️ Lỗi 2: Client hiển thị "Chờ thanh toán" bị đóng băng sau khi bấm nút (UI Freeze)
...
### ⚠️ Lỗi 3: Lỗi khóa Database `[SQLITE_BUSY] The database file is locked`
